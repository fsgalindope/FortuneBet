...
import logica.GeneracionCliente;


public class CreacionCliente extends javax.swing.JFrame {

    TreeMap<String, Cliente> baseDatosClientes;
    ArrayList<Apuesta> catalogo;
    Cliente clienteActual;

    ArrayList<Apuesta> carrito;
    
    
    public CreacionCliente(TreeMap<String, Cliente> baseDatosUsuarios,ArrayList<Apuesta> catalogo) {
        initComponents();
        this.setLocationRelativeTo(null);
        this.setResizable(false);
        getContentPane().setBackground(Color.WHITE);
        this.catalogo=catalogo;
        this.baseDatosClientes=baseDatosUsuarios;
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(inputReingresoNuevaContraseña, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(reingresarContraseña, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(inputNuevaContraseña, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(contraseña, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(inputEdad, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(edad, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(inputCorreo, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        panelTituloLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelTituloLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(VolverAInicio, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void crearUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_crearUsuarioActionPerformed
        ...
        if(!(GeneracionCliente.validarDatosIngresados(inputNombre.getText(),
            ...
            inputId.getText(),baseDatosClientes))){  
                ...
                for(Cliente usuariosBaseDatos: baseDatosClientes.values()){
            ...
            clienteActual=GeneracionCliente.crearCliente(baseDatosClientes,Integer.valueOf(inputId.getText()),inputNombre.getText(),
            inputApellido.getText(), Integer.valueOf(inputEdad.getText()), inputCorreo.getText(),
            inputUsuario.getText(), inputReingresoNuevaContraseña.getText());
            
            MenuCliente buscador = new MenuCliente(baseDatosClientes, catalogo,clienteActual);
    ...
    private void VolverAInicioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VolverAInicioActionPerformed
        ...
        if(respuesta==0){       
        UiInicioCliente inicio2 = new UiInicioCliente(baseDatosClientes,catalogo);
